          ...
          <>
            <div className={styles.cartEmpty}>
              <img
                ...
                alt=""
              />
              <span className={styles.cartOrderedTitle}>Заказ оформлен!</span>
              <p className={styles.cartEmptyInfo}>
              ...
              >
                <svg
                  className={styles.cartEmptyButtonIcon}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="14"
                  viewBox="0 0 16 14"
        ...
        {cartItems.length > 0 && !isOrdered ? (
          <>
            ...
            <div className={styles.total}>
              ...
              <Button onClick={onOrderButtonClick} buttonSize="large">
          ...
          cartItems.length === 0 && !isOrdered && (
            <div className={styles.cartEmpty}>
              <img
                ...
                alt=""
              />
              <span className={styles.cartEmptyTitle}>Корзина пустая</span>
              <p className={styles.cartEmptyInfo}>
